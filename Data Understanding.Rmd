...
``` {r injuries}
library(readr)
NonService <- read_csv("NonService.csv", 
    col_types = cols(EventDate = col_skip(), 
        X1 = col_skip()))
Service <- read_csv("Service.csv", col_types = cols(EventDate = col_skip(), 
    ID = col_integer(), X1 = col_skip()))
```
